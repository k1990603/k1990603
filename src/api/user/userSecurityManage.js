...
export function downLoadRules (str) {
  return `${axios.defaults.baseURL}/export_securitygroup_rule?${str}`
}
// 上传安全组规则 /upload_securitygroup_rule
export function upLoadRules () {
  return `${axios.defaults.baseURL}/upload_securitygroup_rule?`
}

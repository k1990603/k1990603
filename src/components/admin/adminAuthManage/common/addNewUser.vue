<template>
  <div class="addAdminUserInfo dialogTemplate">
    ...
    <el-form :model="userInfo" status-icon :rules="userRules" ref="userInfo" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="所属管理组" prop="group_uuid">
        <el-select v-model="userInfo.group_uuid" placeholder="请选择管理组">
          <el-option v-for="item in groupList" :key="item.value" :label="item.group_name" :value="item.group_uuid">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="submitForm()">提交</el-button>
        <el-button @click="$emit('addUserRes')">取消</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
          ...
          switch (this.userType) {
            case 1:
              this.addExistAdmin({
                ...
                group_uuid: this.userInfo.group_uuid,
                client_user_type:

    ...
    <div class="manageMain">
      ...
      <div class="hidden-sm-and-down logMsg">
        <div class="logMsgLeft">
          ...
          <div class="block hidden-md-and-down">
            <el-date-picker value-format="yyyy-MM-dd hh-ss-mm" @change="dataChange" v-model="value" type="datetimerange" start-placeholder="开始日期" end-placeholder="结束日期">
            </el-date-picker>
          </div>
          <!-- 日期end -->
        </div>
        ...
        <div class="logMsgRight">
          <div>
            ...
            <div class="searchBtn">
              <el-input placeholder="请输入搜索用户" prefix-icon="el-icon-search" v-model="inputContent" @keyup.enter.native="searchEvents" @blur="searchEvents" style="width:150px">
              </el-input>
              <el-cascader :options="options" change-on-select v-model="operaChange" @change="searchChange" clearable style="width:150px"></el-cascader>
            </div>
          </div>
        </div>
        <!-- 筛选框end -->
      ...
      <div class="tabsLIst">
        <el-table :data="tableData" style="width: 100%" :default-sort="{prop: 'date', order: 'descending'}" v-loading="loading">
          ...
          <el-table-column prop="operator_ip" label="用户IP" min-width="110" :show-overflow-tooltip="true">
          </el-table-column>
          <el-table-column prop="object" label="操作对象" min-width="150" :show-overflow-tooltip="true">
          </el-table-column>
...
import { getData } from '@/api/admin/adminLogManagement'
...
export default {
  ...
  methods: {
    ...
    searchEvents() {
      //搜索功能
      this.searchData.operator = this.inputContent
      this.getLogData()
    },
    searchChange() {

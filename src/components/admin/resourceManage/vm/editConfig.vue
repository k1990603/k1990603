<template>
  <div class="editConfigDialog dialogTemplate" v-loading="loading" element-loading-spinner="el-icon-loading" element-loading-text="提交中,请耐心等待...">
...
export default {
  props: ['configList', 'instanceUuid', 'rowInfo'],
  data() {
    return {
      loading: false,
      checkedConfig: 0

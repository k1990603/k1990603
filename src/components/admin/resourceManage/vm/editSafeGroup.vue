<template>
  <div class="editSafeGroupDialog dialogTemplate" v-loading="loading" element-loading-spinner="el-icon-loading" element-loading-text="提交中,请耐心等待...">
...
export default {
  props: ['netCardList', 'instanceUuid'],
  data() {
    return {
      loading: false
    }

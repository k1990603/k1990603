        ...
        <el-row :gutter="20">
          <el-col :span='12'>
            <div class="item">
              ...
              <span class='item-value'>{{info.cpu?info.cpu:0 }}核</span>
            </div>
            <div class="item">
              <span class='item-label'>内存</span>
              <span class='item-value'>{{info.memory_mb?(info.memory_mb >=1024 ? info.memory_mb/1024 + 'G': info.memory_mb+'MB'):0 }}</span>
            </div>
          </el-col>
          <el-col :span='12'>
            <div class="item">
              <span class='item-label'>系统盘容量</span>
              <span class='item-value'>{{info.system_disk?info.system_disk:0 }}G</span>
            </div>
            <div class="item">
              <span class='item-label'>数据盘容量</span>
              <span class='item-value'>{{info.data_disk?info.data_disk:0 }}G</span>
            </div>
          </el-col>
        </el-row>
      </el-card>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span='12'>
            <div class="item">
              ...
              <span class='item-value'>{{info.internet_ip_exist == 0? '暂无':(info.internet_ip?info.internet_ip:'')}}</span>
            </div>
            <div class="item">
              <span class='item-label'>带宽</span>
              <span class='item-value'>{{info.internet_ip_exist == 0? '0':(info.bandwidth_size?info.bandwidth_size:0)}}Mbps</span>
            </div>
          </el-col>
        </el-row>
      </el-card>

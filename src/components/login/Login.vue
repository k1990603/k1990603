        ...
        <div class="login_frame">
          <el-form :model="loginParams" :rules="rules" ref="loginParams">
            <el-form-item prop="userid">
              <div class="item">
                <el-input v-model="loginParams.userid" tabindex='1' @keyup.enter.native="submitForm('loginParams')" placeholder="账号">
            ...
            <el-form-item prop="password">
              <div class="item">
                <el-input @keyup.enter.native="submitForm('loginParams')" tabindex='2' v-model="loginParams.password" type="password" placeholder="密码">
                  <template slot="prepend">
            ...
            <el-form-item>
              ...
              <div class="item" v-if='isLogining'>
                <el-button @click="submitForm('loginParams')" :disabled="isLogining">登&nbsp;录&nbsp;中...&nbsp;</el-button>
              </div>
            </el-form-item>
          </el-form>
        </div>

    ...
    <div class="details-content">
      <div class="details-box">
        <div class="LBdetails_monitor">
          ...
          <!-- 解绑云主机 -->
          <el-dialog width="650px" center :visible.sync="statu.unBind" class='dialogTemplate' title='解绑云主机'>
            <div v-loading="unbindLoading" element-loading-text="提交中,请耐心等待..." element-loading-spinner="el-icon-loading">
              <el-table :data="unbindData" ref='unbindTable' @selection-change="handleUnbindChange" style="width: 100%">
          ...
          <!-- 绑定云主机 -->
          <el-dialog width="650px" @close='unbindLoading=false' center :visible.sync="statu.bind" class='dialogTemplate' title='绑定实例'>
...
export default {
  ...
  data() {
    ...
    return {
      unbindData: [], //解绑虚拟机 已绑定虚拟机列表
      instancerDeatils: [], // 已关联的虚拟机实例
      unbindLoading: false,
      bingLoading: false,
      createLoading: false,
      editLoading: false,
      ...
      powerNum: 1, // 修改权重数值
      weightDelete: false, // 修改权重弹框
      dialogDelete: false, // 解绑/删除弹框
      deleteTitle: '', // 解绑/删除标题
      value2: [],

  ...
  <div class="privatNetPage">
      ...
      <el-row>
        <el-col :xs="6" :sm="4" :md="4">
          <div class="privatNetBtnBtn">
            <el-button size="small" type="primary" @click='$router.push("/sf_cloud/workbench/userPrivatNetCreate")'>
              新建专有网络
            </el-button>
          </div>
        </el-col>
    ...
    <div class="privatNetList">
      <el-table :data="tableData" style="width: 100%" stripe>
        ...
        <el-table-column prop="cidr" :show-overflow-tooltip='true' label="CIDR" min-width="120">
        </el-table-column>

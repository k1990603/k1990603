<template>
  <div v-loading="submitLoading" element-loading-text="提交中,请耐心等待..." element-loading-spinner="el-icon-loading" class="addSafeGroupRule dialogTemplate">
    <div class="SafeGroupRuleInfo">

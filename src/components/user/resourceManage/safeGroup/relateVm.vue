<template>
  <div class="safeGroupTemplatePage">
    ...
    <div class="paginationBox">
      <el-pagination :current-page="paginationInfo.currentPage" :page-sizes="paginationInfo.pageSizes" :page-size="paginationInfo.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="paginationInfo.total">
      </el-pagination>
    </div>
    <el-dialog title="新增关联" width="650px" class="dialogTemplate" :visible.sync="relateStatu.add" center>
      <addVmInstance @addRes='addRes' :instanceList='instanceList' @searchInstance='searchInstance'></addVmInstance>
    </el-dialog>

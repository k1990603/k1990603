    ...
    <div class="lessseeInfo">
      ...
      <el-form v-show="stepActive == 1" label-width="120px" :model="createInfo" status-icon :rules="createRules" ref="lesseeInfo">
        ...
        <el-form-item label="所有者">
          <el-col :span="8">
            <el-input :disabled="true" v-model="createInfo.ownerid">
            </el-input>
          </el-col>
        </el-form-item>
        </el-form-item>
...
import { getTenantArea } from '@/api/user/userAuthManage'
...
export default {
  ...
  created() {
    this.createInfo.ownerid = this.userInfo.user_id
    this.createInfo.tenant_uuid = this.userInfo.tenantInfo.tenant_uuid
    this.loadNode()
    this.getUsers()
  },
  computed: {
